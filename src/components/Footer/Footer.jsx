			...
			{screenWidth > 768 ? (
				<footer className="footer">
					...
					<div className="footer-section">
						...
						<p>
							If you have any complaints or suggestions, you may{" "}
					...
					<div className="footer-section">
						<p>
							...
							<br />
							Regd. Office - Ground Floor, Elegance Tower, Plot No. 8,
							<br />
							Non Hierarchical Commercial Centre, Jasola, New Delhi-110025
							<br />
							For Queries and Grievances, please contact Mr. Hukam Singh.
							<br />
						</p>
						<p>
							Email ID - <a href="mailto:care@amway.com">care@amway.com</a>
							<br />
							Tel: <a href="tel:01244508888">0124-4508888</a>
							<br />
